          ...
          <div class="text-center py-12">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 max-w-md mx-auto">
              ...
              <p class="text-gray-600 mb-6">
                Global application settings are not yet available in the web interface. Most options are configurable through the configuration files. For further details, please refer to the documentation.
              </p>
              <RouterLink
                to="/"
